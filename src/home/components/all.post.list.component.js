...
import { StyleSheet, FlatList, View, Text, Image, ActivityIndicator, Platform} from 'react-native';
...
export default class AllPostListComponent extends React.PureComponent {
    ...
    async componentWillMount() {
        ...
        biggStarsMasterPostRequest.requestType  = 0;
                ...
                <View style={{
                    ...
                    >
                        ...
                        >
                            ...
                            <View
                                style={post.quenes[0] && post.quenes[0].award > 0 ? {
                                width: '43%',
                                ...
                                <Text style={{textAlign: 'right'}}>
                                    ...
                                    <Text style={{  }}>{post.quenes[0].award}</Text>
                                </Text>
                        ...
                        >
                            <View style={{flexDirection: 'row', paddingTop: 20 } }>
                                ...
                                <View style={{justifyContent: 'center'}}>
                                    <Text style={{fontWeight: 'bold', color: '#455A64'}}>{graceName}</Text>
                                </View>
                            </View>

                            <View style={{flexDirection: 'row', paddingTop: 10}}>
                                <Text style={{color: '#FFA000', fontWeight: 'bold', fontSize: 12}}>
                                    {post.fromUserName}
                                    <Text style={{color: '#455A64', fontSize: 12}}>
